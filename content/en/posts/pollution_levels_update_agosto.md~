---
author: "Bart"
title: "El aire que respiramos durante el confinamiento (actualización con datos de abril)"
date: 2020-05-01T12:00:06+09:00
description: "Evolución de los niveles de polución en Granada durante la cuarentena (actualización con datos de abril)"
draft: false
hideToc: false
enableToc: true
...
#### [Este post es una actualización de uno más antiguo, dónde podréis encontrar información sobre dónde encontré los datos, tips para dibujar el gráfico y qué significa](https://thebooort.github.io/posts/pollution_levels/)
...
<iframe width="100%" height="700" src="/images/plot_no2_con_abril.html">
</iframe>

## Conclusions!

La tendencia visible ya es muy destacable. Los niveles están muy reducidos frente al año anterior. Puede que tengamos un pequeño repunte que podemos correlacionar con el fin del confinamiento más estricto, pero aún así los niveles siguen muy bajos y, desde luego, son buenas noticias.
